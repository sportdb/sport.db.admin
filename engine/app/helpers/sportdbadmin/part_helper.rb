...
module PartHelper
  ...
  def render_game_flags( game, opts={} )
    render :partial => 'shared/td_game_flags', :locals => { :game => game }
  end

  def render_game_debug( game, opts={} )
    render :partial => 'shared/td_game_debug', :locals => { :game => game }
  end

  def render_game_round( game, opts={} )
    render :partial => 'shared/td_game_round', :locals => { :game => game }
  end


  def render_team_world_tree( team, opts={} )
    render :partial => 'shared/team_world_tree', :locals => { :team => team }
  end
